...
const StandardDiscount = () => {
    ...
    const handleEdit = async (id) => {
        try {
            const response = await axios.get(`https://diamondsoft-backend.onrender.com/api/sdiscount/${id}`);
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            await axios.put(`https://diamondsoft-backend.onrender.com/api/sdiscount/${formData.id}`, UpdatedFormData);
    ...
    const handleDelete = async (id) => {
        try {
            ...
            await axios.delete(`https://diamondsoft-backend.onrender.com/api/sdiscount/${id}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await axios.post('https://diamondsoft-backend.onrender.com/api/sdiscount', InsertedFormData);
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            await axios.post('https://diamondsoft-backend.onrender.com/api/sdiscount/upload', formData, {
                headers: {
            ...
            <div className='grid grid-cols-1 md:grid-cols-8 p-2'>
                ...
                <div className='col-span-1 md:col-span-2 p-2'>
                    <form className='bg-teal-200 p-4 rounded-lg'>
                        <div className="">
                            <h1 className="text-2xl font-bold mb-4">SET STANDARD DISCOUNT</h1>
                            <label className="block ">ENTER STANDARD DISCOUNT ID</label>
                            <input
                                type="number"
                                name="id"
                                value={formData.id}
                ...
                <div className='col-span-1 md:col-span-6 p-2'>
                    ...
                    <div className='bg-teal-200 w-full mb-4 p-2 sm:flex justify-center items-center rounded-lg'>
                        <label className="text-lg font-bold ">UPLOAD YOUR STANDARD DISCOUNT CSV</label>
                        <input
                            type="file"
                            accept=".csv"
                    ...
                    <div className="bg-teal-200 w-full p-4 rounded-lg">
                        <h2 className="text-xl font-bold mb-2">STANDARD DISCOUNT DATA</h2>
